...
export default function OverviewPage({ obligations, goals, buckets, cm, income, onDeleteIncome, onEditIncome }) {
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      <IncomeLog income={income} onDelete={onDeleteIncome} onEdit={onEditIncome} />
